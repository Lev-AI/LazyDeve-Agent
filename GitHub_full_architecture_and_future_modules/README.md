...
Even a small mismatch between intended behavior and what gets implemented can break logic and lead to a long-lasting issues, introduce regressions, or silently corrupt architecture.
...
azyDeve operates **directly on a developer’s local machine**, interacting with the real filesystem and project sources. This execution model requires explicit safeguards.
